...
def calculate_route_distance(data, route1, route2):
    """
    ...
    distance1 = calculate_single_route_distance(route1)
    distance2 = calculate_single_route_distance(route2)
...
def main():
    ...
    check =[
        [0,1,7,0],
        [0,5,4,6,10,3,9,12,11,2,8,0]
    ]
    sample=[
        [0 ,5, 1 ,7 ,11, 0 ],
        [0, 4, 6 ,10 ,3 ,9 ,12, 2, 8 ,0 ]
    ]
    print(calculate_route_distance(data, check[0], check[1]))
    print(calculate_route_distance(data, sample[0], sample[1]))
